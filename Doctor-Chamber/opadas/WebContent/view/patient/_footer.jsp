...
<footer>
	<p>
		&copy 2023 OPADAS . All Rights Reserved | Developed by <a
			href="https://www.linkedin.com/in/or-imon/" target="_blank">O R Imon</a>
	</p>
</footer>
<!--footer section end-->
</div>
...
<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu">
			...
			<li><a href="#"><i class="fa fa-smile-o"></i> <span>Search Prescription</span></a></li>
