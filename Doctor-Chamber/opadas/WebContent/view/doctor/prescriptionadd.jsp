									...
									<div class="validation-form">
										...
										<div class="graph-form">
											...
											<div class="vali-form">
												...
												<div class="col-md-3 form-group1 form-last">
													<input type="text" placeholder="Prescription Id" name="prescriptionid" required="">
												</div>
												<div class="col-md-3 form-group1 form-last">
													<input type="text" placeholder="Height(Ex: 5.6 inc)" name="height" required="">
												</div>
												<div class="col-md-3 form-group1 form-last">
													<input type="text" placeholder="Weight(Ex: 50kg)" name="weight" required="">
												</div>
												<div class="clearfix"></div>
											</div>
											</div>
											...
											<div class="vali-form">
												...
												<div class="col-md-3 form-group1 form-last">
													<input type="text" placeholder="BP(Ex: 80-120)" name="bloodpresuere">
												</div>
												<div class="col-md-3 form-group1 form-last">
													<input type="text" placeholder="Temparature" name="temparature">
												</div>
												<div class="col-md-3 form-group1 form-last">
													<input type="text" placeholder="Disease Name" name="diseasename">
												</div>
												<div class="clearfix"></div>
											</div>
											</div>
											...
											<div class="col-md-12 form-group2">
												...
												<input type="button" name="addmedicine" value="add" style="float:right; background-color:#052963; color: white;">
											...
											<div class="vali-form">
												...
												<div class="col-md-2 form-group1 form-last">
													<input type="text" placeholder="mg/ml" name="mgml" required="">
												</div>
